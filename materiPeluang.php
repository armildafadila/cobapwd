...
$fungsi = mysqli_query($koneksi, "SELECT * FROM soal WHERE id_materi='9'");
...
<div class="d-flex justify-content-center mt-4">
  <div class="card p-3">
        <div class="card-header">
          ...
          <span class="isi-atas">PELUANG</span>
          </div>
        <hr>
  ...
  <div class="card-bawah p-3">
        <div class="card-bodyr">
          <form class="form" action="proseshasil.php" method="POST">
            <input type="hidden" name="id_materi" value="9">
            <input type="hidden" name="id_users" value="9">
