...
$fungsi = mysqli_query($koneksi, "SELECT * FROM soal WHERE id_materi='6'");
...
<div class="d-flex justify-content-center mt-4">
  <div class="card p-3">
        <div class="card-header">
          ...
          <span class="isi-atas">PROGRAM LINIER</span>
          </div>
        <hr>

          <div class="baris-soal">
          <span class="text-atas">Kelas</span>
          <span class="isi-bawah"> 11 </span>
    </div>      
    </div>
</div>
</div>
  ...
  <div class="card-bawah p-3">
        <div class="card-bodyr">
          <form class="form" action="proseshasil.php" method="POST">
            <input type="hidden" name="id_materi" value="6">
            <input type="hidden" name="id_users" value="6">
